...
Read the following articles in this order:

-   [Project Folder Structure](./01-project-folder-structure.md)
-   [Claude Hooks](./02-claude-hooks.md)
-   [Web App Overview](./03-web-app-overview.md)
-   [Phase 1: Core Session Logging](./04-phase-1-core-session-logging.md)
-   [Phase 2: Project Matching, Transcript Parsing, and Event Grouping](./05-phase-2-project-matching.md)
-   [Phase 3: Auto-Naming, Summaries, and Link Extraction in Session Management](./06-phase-3-auto-naming-summaries.md)
-   [Phase 4: Interactive Messaging and Session Management in Claude Code](./07-phase-4-interactive-messaging.md)
